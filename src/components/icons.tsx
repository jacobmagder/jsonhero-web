...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  // You can add common props here if needed, like size, etc.
}
...
export const TreeViewIcon: React.FC<IconProps> = (props) => (
  // A simple tree-like icon
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-4-8h8M8 10l-4 4 4 4m8-8l4 4-4-4" />
    {/* A more abstract tree like JSON Hero's TreeIcon (simplified) */}
    {/* <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75l-7.5-7.5-7.5 7.5m15 0l-7.5 7.5-7.5-7.5" /> */}
  </svg>
);
